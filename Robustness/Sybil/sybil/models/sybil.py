...
class SybilNet(nn.Module):
    ...
    def forward(self, x, batch=None):
        ...
        output['features'] = pool_output['features'] # this is the features before relu and dropout 
        output["activ"] = x
    ...
    def aggregate_and_classify(self, x):
        ...
        # extract features before relu and dropout 
        pool_output['features'] = pool_output['hidden']
